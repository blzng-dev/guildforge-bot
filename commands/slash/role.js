...
module.exports = {
  ...
  .addSubcommand(subcommand => subcommand.setName("create").setDescription("create a new role").addStringOption(option => option.setName("name").setDescription("name for the new role").setRequired(true)).addStringOption(option => option.setName("color").setDescription("hex color code").setRequired(false)).addStringOption(option => option.setName("secondary_color").setDescription("secondary hex color code for gradient role").setRequired(false)).addBooleanOption(option => option.setName("hoist").setDescription("hoist role in member list").setRequired(false)).addBooleanOption(option => option.setName("mentionable").setDescription("allow anyone to mention this role").setRequired(false)).addRoleOption(option => option.setName("below_role").setDescription("position below this role").setRequired(false)).addRoleOption(option => option.setName("above_role").setDescription("position above this role").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("create-bulk").setDescription("create multiple roles via modal").addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("preset").setDescription("create a role from preset").addStringOption(option => option.setName("preset_name").setDescription("select permission preset").setRequired(true).addChoices({
    ...
    name: "Administrator",
    value: "admin"
  })).addStringOption(option => option.setName("role_name").setDescription("optional custom name").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("list").setDescription("list server roles").addBooleanOption(option => option.setName("hoisted").setDescription("filter by hoisted roles").setRequired(false)).addBooleanOption(option => option.setName("pingable").setDescription("filter by pingable roles").setRequired(false)).addBooleanOption(option => option.setName("has_admin").setDescription("filter by admin roles").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("color").setDescription("create color roles").addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("scrape").setDescription("scrapes server roles into a json file.").addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("info").setDescription("display role information").addRoleOption(option => option.setName("role").setDescription("the role to get info for").setRequired(true)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("export").setDescription("export roles to json").addRoleOption(option => option.setName("target").setDescription("single role to export").setRequired(false)).addRoleOption(option => option.setName("start_role").setDescription("start of role range to export").setRequired(false)).addRoleOption(option => option.setName("end_role").setDescription("end of role range to export").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("import").setDescription("import roles from json").addAttachmentOption(option => option.setName("file").setDescription("the exported json file").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("toggle").setDescription("toggle role for a user").addRoleOption(option => option.setName("role").setDescription("the role to toggle").setRequired(true)).addUserOption(option => option.setName("user").setDescription("the user to toggle the role for").setRequired(true)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => {
    ...
    return subcommand;
  }).addSubcommand(subcommand => subcommand.setName("clear").setDescription("clear all permissions from roles").addRoleOption(option => option.setName("target").setDescription("role to clear (leave empty for multiple)").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("delete").setDescription("delete roles").addRoleOption(option => option.setName("target").setDescription("role to delete (leave empty for multiple)").setRequired(false)).addRoleOption(option => option.setName("start_role").setDescription("start role for range deletion").setRequired(false)).addRoleOption(option => option.setName("end_role").setDescription("end role for range deletion").setRequired(false)).addBooleanOption(option => option.setName("include_boundaries").setDescription("include start/end roles in deletion? (default false)").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("migrate").setDescription("migrate members between roles").addRoleOption(option => option.setName("primary_role").setDescription("the role to assign").setRequired(true)).addRoleOption(option => option.setName("secondary_role").setDescription("the role to select from").setRequired(true)).addBooleanOption(option => option.setName("transcript").setDescription("generate transcript before migration").setRequired(false)).addBooleanOption(option => option.setName("delete_secondary").setDescription("delete secondary role after migration").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("transfer").setDescription("copy roles from one user to another").addUserOption(option => option.setName("from").setDescription("the user to copy roles from").setRequired(true)).addUserOption(option => option.setName("to").setDescription("the user to copy roles to").setRequired(true)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))).addSubcommand(subcommand => subcommand.setName("reorder").setDescription("re-arrange roles by moving them above or below a pivot role.").addRoleOption(option => option.setName("pivot").setDescription("the pivot role").setRequired(true)).addStringOption(option => option.setName("position").setDescription("place above or below pivot (default below)").addChoices({
    name: "Above",
    value: "above"
  }, {
    name: "Below",
    value: "below"
  }).setRequired(false)).addRoleOption(option => option.setName("target").setDescription("single role to move").setRequired(false)).addRoleOption(option => option.setName("range_start").setDescription("start of role range to move").setRequired(false)).addRoleOption(option => option.setName("range_end").setDescription("end of role range to move").setRequired(false)).addBooleanOption(option => option.setName("ephemeral").setDescription("Whether the response should be ephemeral (default: true)").setRequired(false))),
